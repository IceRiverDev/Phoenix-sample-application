...
@RestController
@RequestMapping("/api/phoenix-application-kafka")
public class PhoenixApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PhoenixApplicationKafkaResource.class);
    ...
    public PhoenixApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
